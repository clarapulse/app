...
class ConnectContainerWidgetState extends  State<ConnectContainerWidget>{
  ...
  List<UserData> list = [UserData.fullProfile("example@gmail.com", "John Doe", "https://lh5.googleusercontent.com/-gKe8qUDkXJc/AAAAAAAAAAI/AAAAAAAAAAA/AMZuuclhbf3_xwxozpf8XweRZrtOC91oIA/s96-c/photo.jpg", "", "University of California San Diego", false),
      ...
      UserData.fullProfile("example@gmail.com", "Jeff Kaplan", "https://lh5.googleusercontent.com/-gKe8qUDkXJc/AAAAAAAAAAI/AAAAAAAAAAA/AMZuuclhbf3_xwxozpf8XweRZrtOC91oIA/s96-c/photo.jpg", "Dougherty Valley High School", "", true),
      UserData.fullProfile("example@gmail.com", "Alan Smith", "https://lh5.googleusercontent.com/-gKe8qUDkXJc/AAAAAAAAAAI/AAAAAAAAAAA/AMZuuclhbf3_xwxozpf8XweRZrtOC91oIA/s96-c/photo.jpg", "San Diego University", "", true)];
                          ...
                          child: Container(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(height: 10),
                                Text(
                                  (card.inHighSchool) ? card.highSchool : card.university,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 14.0,
                                  )
                                ...
                                SizedBox(height: 10),
                                Text(
                                  (card.inHighSchool) ? "Prospective Major: " + "Computer Science": "Major: "+"Computer Science",
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 14.0,
                                  )
